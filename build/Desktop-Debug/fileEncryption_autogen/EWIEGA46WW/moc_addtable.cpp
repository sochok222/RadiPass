...
static constexpr auto qt_meta_stringdata_ZN8AddTableE = QtMocHelpers::stringData(
    "AddTable",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8AddTableE[] = {
...
Q_CONSTINIT const QMetaObject AddTable::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8AddTableE.offsetsAndSizes,
    qt_meta_data_ZN8AddTableE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8AddTableE_t,
        // Q_OBJECT / Q_GADGET
...
void AddTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_addTableButton_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
void *AddTable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8AddTableE.stringdata0))
