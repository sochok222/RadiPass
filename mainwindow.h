...
private: // Icons
    QIcon iconTrash = QIcon(":/icons/trash.png");
    QIcon iconAdd = QIcon(":/icons/add.png");
    QIcon iconEdit = QIcon(":/icons/edit.png");
    QIcon iconKey = QIcon(":/icons/key.png");
    QIcon iconCopy = QIcon(":/icons/copy.png");
    QIcon iconUrl = QIcon(":/icons/url.png");
    QIcon iconUser = QIcon(":/icons/user.png");
    QIcon iconOpenUrl = QIcon(":/icons/openUrl.png");
    QIcon iconSetting = QIcon(":/icons/setting.png");
    QIcon iconOpen = QIcon(":/icons/open.png");
    QIcon iconCreateNew = QIcon(":/icons/createNew.png");
    QIcon iconClose = QIcon(":/icons/close.png");
};
#endif // MAINWINDOW_H
